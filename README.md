...
| [sagemath-wrapper](services/sagemath-wrapper/README.md) | Python | [![CI](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-sagemath-wrapper.yml/badge.svg)](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-sagemath-wrapper.yml) | — | SageMath REST/CLI wrapper — SAT solving, linear algebra, MILP, symbolic calculus, sandboxed |
