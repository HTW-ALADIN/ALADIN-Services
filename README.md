...
[![text-similarity-service CI](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-text-similarity-service.yml/badge.svg)](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-text-similarity-service.yml)
[![text-template-service CI](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-text-template-service.yml/badge.svg)](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-text-template-service.yml)
[![natural-language-generation-service CI](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-natural-language-generation-service.yml/badge.svg)](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-natural-language-generation-service.yml)
...
| [academic-search-service](services/academic-search-service/README.md) | Python | [![CI](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-academic-search-service.yml/badge.svg)](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-academic-search-service.yml) | [![codecov](https://codecov.io/gh/HTW-ALADIN/ALADIN-Services/graph/badge.svg?flag=academic-search-service)](https://codecov.io/gh/HTW-ALADIN/ALADIN-Services?flags[0]=academic-search-service) | Unified search/export/download/citation-graph API over academic-mcp and scimesh |
...
| [text-similarity-service](services/text-similarity-service/README.md) | Python (+ **optional** Java sidecar in `dkpro-sidecar/`) | [![CI](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-text-similarity-service.yml/badge.svg)](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-text-similarity-service.yml) | — | Unified REST API for semantic text similarity — 16 algorithm families over multiple backends; **optional** DKPro sidecar adds `topic_model` and `structural_stylistic`. See [dkpro-sidecar cost/benefit](services/text-similarity-service/README.md#dkpro-sidecar-optional) |
| [text-template-service](services/text-template-service/README.md) | Rust | [![CI](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-text-template-service.yml/badge.svg)](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-text-template-service.yml) | [![codecov](https://codecov.io/gh/HTW-ALADIN/ALADIN-Services/graph/badge.svg?flag=text-template-service)](https://codecov.io/gh/HTW-ALADIN/ALADIN-Services?flags[0]=text-template-service) | Stateless MiniJinja text rendering through matching REST and CLI contracts |
| [natural-language-generation-service](services/natural-language-generation-service/README.md) | TypeScript | [![CI](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-natural-language-generation-service.yml/badge.svg)](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-natural-language-generation-service.yml) | [![codecov](https://codecov.io/gh/HTW-ALADIN/ALADIN-Services/graph/badge.svg?flag=natural-language-generation-service)](https://codecov.io/gh/HTW-ALADIN/ALADIN-Services?flags[0]=natural-language-generation-service) | Rule-based surface realisation and trusted template NLG with jsRealB and RosaeNLG (15/15 capability families) |
