...
| [text-template-service](services/text-template-service/README.md) | Rust | [![CI](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-text-template-service.yml/badge.svg)](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-text-template-service.yml) | — | Stateless MiniJinja text rendering through matching REST and CLI contracts |
