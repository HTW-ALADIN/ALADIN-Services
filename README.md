...
| [noise-generation-service](services/noise-generation-service/README.md) | Rust | [![CI](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-noise-generation-service.yml/badge.svg)](https://github.com/HTW-ALADIN/ALADIN-Services/actions/workflows/service-noise-generation-service.yml) | [![codecov](https://codecov.io/gh/HTW-ALADIN/ALADIN-Services/graph/badge.svg?flag=noise-generation-service)](https://codecov.io/gh/HTW-ALADIN/ALADIN-Services?flags[0]=noise-generation-service) | Noise Generation — unified REST API for multiple noise generation libraries and algorithms |
