...
def _rapidfuzz_damerau_levenshtein(
    pair: InputPair, params: dict[str, Any]
) -> ScalarDistanceResult:
...
def _rapidfuzz_hamming(pair: InputPair, params: dict[str, Any]) -> ScalarDistanceResult:
...
def _rapidfuzz_osa(pair: InputPair, params: dict[str, Any]) -> ScalarDistanceResult:
...
def _rapidfuzz_indel(pair: InputPair, params: dict[str, Any]) -> ScalarDistanceResult:
...
def _textdistance_damerau_levenshtein(
    pair: InputPair, params: dict[str, Any]
) -> ScalarDistanceResult:
    import textdistance
...
def _textdistance_jaro_winkler(
    pair: InputPair, params: dict[str, Any]
) -> ScalarDistanceResult:
    import textdistance
...
def _textdistance_lcs(pair: InputPair, params: dict[str, Any]) -> SequenceResult:
    import textdistance
...
def _textdistance_needleman_wunsch(
    pair: InputPair, params: dict[str, Any]
) -> AlignmentResult:
    import textdistance
...
def _textdistance_smith_waterman(
    pair: InputPair, params: dict[str, Any]
) -> ScalarDistanceResult:
    import textdistance
...
def _textdistance_ncd(pair: InputPair, params: dict[str, Any]) -> ScalarDistanceResult:
    import textdistance
...
def _jellyfish_damerau_levenshtein(
    pair: InputPair, params: dict[str, Any]
) -> ScalarDistanceResult:
    import jellyfish
...
def _jellyfish_hamming(pair: InputPair, params: dict[str, Any]) -> ScalarDistanceResult:
    import jellyfish
...
def _jellyfish_jaro_winkler(
    ...
    if variant == "jaro_winkler":
        s = jellyfish.jaro_winkler_similarity(
            pair.a, pair.b, long_tolerance=long_tolerance
        )
    else:
...
def _jellyfish_phonetic(
    input_item: InputPhonetic, params: dict[str, Any]
) -> PhoneticCodeResult:
    import jellyfish
...
def _edlib_long_sequence_alignment(
    pair: InputPair, params: dict[str, Any]
) -> AlignmentResult:
    import edlib
    ...
    if raw_locations is not None:
        locations = [list(loc) for loc in raw_locations]
...
def _diff_match_patch_diff(pair: InputPair, params: dict[str, Any]) -> EditScriptResult:
...
def compute_text(
    ...
    Returns (results, result_type, elapsed_ms).
    """
...
ALGORITHM_CATALOG = [
    {
        ...
        "backend": "rapidfuzz",
        "families": ["Levenshtein distance"],
        "result_type": "scalar_distance",
        "description": "Levenshtein edit distance (RapidFuzz C++ backend)",
    },
    {
        "algorithm": "levenshtein",
        "backend": "textdistance",
        "families": ["Levenshtein distance"],
        "result_type": "scalar_distance",
        "description": "Levenshtein edit distance (textdistance pure Python)",
    },
    {
        "algorithm": "levenshtein",
        "backend": "jellyfish",
        "families": ["Levenshtein distance"],
        "result_type": "scalar_distance",
        "description": "Levenshtein edit distance (jellyfish Rust core)",
    },
    {
        "algorithm": "levenshtein",
        "backend": "edlib",
        "families": ["Levenshtein distance", "Long-sequence banded alignment"],
        "result_type": "scalar_distance",
        "description": "Levenshtein distance via edlib (banded NW, for long sequences)",
    },
    {
        "algorithm": "damerau_levenshtein",
        "backend": "rapidfuzz",
        "families": ["Damerau-Levenshtein distance"],
        "result_type": "scalar_distance",
    ...
    },
    {
        ...
        "families": ["Damerau-Levenshtein distance"],
        "result_type": "scalar_distance",
        "description": "Damerau-Levenshtein distance (textdistance)",
    },
    {
        "algorithm": "damerau_levenshtein",
        "backend": "jellyfish",
        "families": ["Damerau-Levenshtein distance"],
        "result_type": "scalar_distance",
        "description": "Damerau-Levenshtein distance (jellyfish)",
    },
    {
        "algorithm": "hamming",
        "backend": "rapidfuzz",
        "families": ["Hamming distance"],
        "result_type": "scalar_distance",
        "description": "Hamming distance (RapidFuzz)",
    },
    {
        "algorithm": "hamming",
        "backend": "textdistance",
        "families": ["Hamming distance"],
        "result_type": "scalar_distance",
        "description": "Hamming distance (textdistance)",
    },
    {
        "algorithm": "hamming",
        "backend": "jellyfish",
        "families": ["Hamming distance"],
        "result_type": "scalar_distance",
        "description": "Hamming distance (jellyfish)",
    },
    {
        "algorithm": "jaro_winkler",
        "backend": "rapidfuzz",
        "families": ["Jaro / Jaro-Winkler similarity"],
        "result_type": "scalar_distance",
    ...
    },
    {
        ...
        "families": ["Jaro / Jaro-Winkler similarity"],
        "result_type": "scalar_distance",
        "description": "Jaro-Winkler similarity (textdistance)",
    },
    {
        "algorithm": "jaro_winkler",
        "backend": "jellyfish",
        "families": ["Jaro / Jaro-Winkler similarity"],
        "result_type": "scalar_distance",
        "description": "Jaro-Winkler similarity (jellyfish)",
    },
    {
        "algorithm": "osa",
        "backend": "rapidfuzz",
        "families": ["Optimal String Alignment"],
        "result_type": "scalar_distance",
        "description": "Optimal String Alignment (RapidFuzz)",
    },
    {
        "algorithm": "indel",
        "backend": "rapidfuzz",
        "families": ["Indel (LCS-based edit distance)"],
        "result_type": "scalar_distance",
        "description": "Indel/LCS-based distance (RapidFuzz)",
    },
    {
        "algorithm": "indel",
        "backend": "textdistance",
        "families": ["Indel (LCS-based edit distance)"],
        "result_type": "scalar_distance",
        "description": "Indel/LCS-based distance (textdistance)",
    },
    {
        "algorithm": "lcs",
        "backend": "textdistance",
        "families": ["Longest Common Subsequence"],
        "result_type": "sequence",
        "description": "Longest Common Subsequence extraction (textdistance)",
    },
    {
        "algorithm": "needleman_wunsch",
        "backend": "textdistance",
        "families": ["Needleman-Wunsch global alignment"],
        "result_type": "alignment",
        "description": "Needleman-Wunsch global alignment (textdistance)",
    },
    {
        "algorithm": "gotoh",
        "backend": "textdistance",
        "families": ["Gotoh affine-gap alignment"],
        "result_type": "scalar_distance",
        "description": "Gotoh affine-gap alignment distance (textdistance)",
    },
    {
        "algorithm": "smith_waterman",
        "backend": "textdistance",
        "families": ["Smith-Waterman local alignment"],
        "result_type": "scalar_distance",
        "description": "Smith-Waterman local alignment (textdistance)",
    },
    {
        "algorithm": "token_set_similarity",
        "backend": "textdistance",
        "families": ["Token/set similarity (Jaccard, Sørensen-Dice, Tversky, Cosine)"],
        "result_type": "scalar_distance",
        "description": "Token/set similarity bundle (textdistance)",
    },
    {
        "algorithm": "ncd",
        "backend": "textdistance",
        "families": ["Normalized Compression Distance"],
        "result_type": "scalar_distance",
        "description": "Normalized Compression Distance (textdistance)",
    },
    {
        "algorithm": "phonetic_encoding",
        "backend": "jellyfish",
        "families": ["Phonetic encoding + Match Rating Comparison"],
        "result_type": "phonetic_code",
        "description": "Phonetic encoding (Soundex, Metaphone, NYSIIS) via jellyfish",
    },
    {
        "algorithm": "long_sequence_alignment",
        "backend": "edlib",
        "families": ["Long-sequence banded/bit-vector alignment"],
        "result_type": "alignment",
        "description": "Banded/bit-vector alignment with CIGAR (edlib)",
    },
    {
        "algorithm": "diff_patch",
        "backend": "diff_match_patch",
        "families": ["Edit-script / diff (Myers) + patch application"],
        "result_type": "edit_script",
        "description": "Myers diff with edit-script output (diff-match-patch)",
    },
]
