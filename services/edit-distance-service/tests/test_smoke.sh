...
test_endpoint "Levenshtein (RapidFuzz)" "POST" "/v1/text/compare" \
    '{"algorithm":"levenshtein","params":{},"inputs":[{"id":"p1","a":"kitten","b":"sitting"}]}' "200"
...
test_endpoint "Damerau-Levenshtein (RapidFuzz)" "POST" "/v1/text/compare" \
    '{"algorithm":"damerau_levenshtein","params":{},"inputs":[{"id":"p1","a":"jellyfish","b":"jellyfihs"}]}' "200"

test_endpoint "Hamming (RapidFuzz)" "POST" "/v1/text/compare" \
    '{"algorithm":"hamming","params":{},"inputs":[{"id":"p1","a":"karolin","b":"kathrin"}]}' "200"

test_endpoint "Jaro-Winkler (RapidFuzz)" "POST" "/v1/text/compare" \
    '{"algorithm":"jaro_winkler","params":{},"inputs":[{"id":"p1","a":"MARTHA","b":"MARHTA"}]}' "200"

test_endpoint "OSA (RapidFuzz)" "POST" "/v1/text/compare" \
    '{"algorithm":"osa","params":{},"inputs":[{"id":"p1","a":"ca","b":"abc"}]}' "200"

test_endpoint "Indel (RapidFuzz)" "POST" "/v1/text/compare" \
    '{"algorithm":"indel","params":{},"inputs":[{"id":"p1","a":"kitten","b":"sitting"}]}' "200"

# Text ED - textdistance-only algorithms
test_endpoint "LCS (textdistance)" "POST" "/v1/text/compare" \
    '{"algorithm":"lcs","params":{},"inputs":[{"id":"p1","a":"kitten","b":"sitting"}]}' "200"

test_endpoint "Needleman-Wunsch (textdistance)" "POST" "/v1/text/compare" \
    '{"algorithm":"needleman_wunsch","params":{"gap_cost":1.0},"inputs":[{"id":"p1","a":"kitten","b":"sitting"}]}' "200"

test_endpoint "Smith-Waterman (textdistance)" "POST" "/v1/text/compare" \
    '{"algorithm":"smith_waterman","params":{},"inputs":[{"id":"p1","a":"kitten","b":"sitting"}]}' "200"

test_endpoint "Token set similarity (textdistance)" "POST" "/v1/text/compare" \
    '{"algorithm":"token_set_similarity","params":{"metric":"jaccard"},"inputs":[{"id":"p1","a":"hello world","b":"world hello"}]}' "200"

test_endpoint "NCD (textdistance)" "POST" "/v1/text/compare" \
    '{"algorithm":"ncd","params":{"qval":1,"compressor":"zlib"},"inputs":[{"id":"p1","a":"kitten","b":"sitting"}]}' "200"

# Text ED - jellyfish phonetic
test_endpoint "Phonetic encoding (jellyfish)" "POST" "/v1/text/compare" \
    '{"algorithm":"phonetic_encoding","params":{"scheme":"soundex"},"inputs":[{"id":"w1","text":"Jellyfish"}]}' "200"

# Text ED - Tier 2 (edlib + diff-match-patch)
test_endpoint "Long sequence alignment (edlib)" "POST" "/v1/text/compare" \
    '{"algorithm":"long_sequence_alignment","params":{"mode":"NW","task":"distance"},"inputs":[{"id":"p1","a":"kitten","b":"sitting"}]}' "200"

test_endpoint "Diff/Patch (diff-match-patch)" "POST" "/v1/text/compare" \
    '{"algorithm":"diff_patch","params":{},"inputs":[{"id":"p1","a":"The quick brown fox","b":"The slow brown fox"}]}' "200"

# Graph ED
test_endpoint "GED A* (NetworkX)" "POST" "/v1/graphs/ged/compute" \
    '{"algorithm":"ged_astar","params":{"mode":"exact","timeout_ms":5000},"graphs":[{"id":"pair-1","g1":{"nodes":[{"id":"A"},{"id":"B"}],"edges":[{"source":"A","target":"B"}]},"g2":{"nodes":[{"id":"A"},{"id":"B"},{"id":"C"}],"edges":[{"source":"A","target":"B"},{"source":"B","target":"C"}]}}]}' "201"

test_endpoint "GED A* (NetworkX, anytime)" "POST" "/v1/graphs/ged/compute" \
    '{"algorithm":"ged_astar","params":{"mode":"anytime","timeout_ms":3000},"graphs":[{"id":"pair-1","g1":{"nodes":[{"id":"1"},{"id":"2"}],"edges":[{"source":"1","target":"2"}]},"g2":{"nodes":[{"id":"1"},{"id":"2"},{"id":"3"}],"edges":[{"source":"1","target":"2"},{"source":"2","target":"3"}]}}]}' "201"

# Batch text comparison
test_endpoint "Batch text compare" "POST" "/v1/text/compare" \
    '{"algorithm":"levenshtein","params":{},"inputs":[{"id":"p1","a":"kitten","b":"sitting"},{"id":"p2","a":"flaw","b":"lawn"}]}' "200"
